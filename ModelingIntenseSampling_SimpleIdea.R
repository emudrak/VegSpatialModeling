...
for (i in unique(Census.Train$Shrub)) {  # i=ShrubNumber
    ...
    if (plotscheme=="fire") mycol=firecols[theseplots$Fire[1] ]     else if (plotscheme=="rain") mycol=watercols[theseplots$Rain[1] ]    else if (plotscheme=="direction") mycol=firecols[theseplots$TranDir[1] ]
