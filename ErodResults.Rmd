...
This time using `TargSpec`

Response seems to be zero-inflated

```{r ExplorDatAnalysis, echo=FALSE, fig.height=2}
par(mfrow=c(1,2))
...
Drop drought treatment?

```{r drop drought, echo=FALSE, fig.width=6, fig.height=4}
...
Ugh still looks zero inflated.  Work with whole data
...
# 
# hurdle7.lme=glmer(TargPres ~ PlotDist+Area_Bot+Fire+Rain + PlotDist:Fire + PlotDist:Rain + Area_Bot:Fire + Fire:Rain + PlotDist:Fire:Rain + (1|Shrub),   family=binomial, data=Census.Train[Census.Train$MHcode>1,],control = glmerControl(optimizer = "bobyqa"))
# summary(hurdle7.lme)
...
hurdle10.lme=glmer(TargPres ~ PlotDist  + Fire + Rain + PlotDist:Fire + PlotDist:Rain + Fire:Rain + (1|Shrub),   family=binomial, data=Census.Train[Census.Train$MHcode>1,],control = glmerControl(optimizer = "bobyqa"))
summary(hurdle10.lme)
drop1(hurdle10.lme, test="Chisq")


hurdle11.lme=glmer(TargPres ~ PlotDist  + Fire + Rain + PlotDist:Rain + Fire:Rain + (1|Shrub),   family=binomial, data=Census.Train[Census.Train$MHcode>1,],control = glmerControl(optimizer = "bobyqa"))
summary(hurdle11.lme)
drop1(hurdle11.lme, test="Chisq")



hurdle12.lme=glmer(TargPres ~ PlotDist  + Fire + Rain + PlotDist:Rain + (1|Shrub),   family=binomial, data=Census.Train[Census.Train$MHcode>1,],control = glmerControl(optimizer = "bobyqa"))
summary(hurdle12.lme)
drop1(hurdle12.lme, test="Chisq")



hurdle13.lme=glmer(TargPres ~ PlotDist + Rain + PlotDist:Rain + (1|Shrub),   family=binomial, data=Census.Train[Census.Train$MHcode>1,],control = glmerControl(optimizer = "bobyqa"))
summary(hurdle13.lme)
drop1(hurdle13.lme, test="Chisq")
...
Census.Test[Census.Test$MHcode>1,"HurdPred"]=predict(hurdle13.lme,  newdata=Census.Test[Census.Test$MHcode>1,], allow.new.levels=TRUE )
